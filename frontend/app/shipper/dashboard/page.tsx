        ...
        <div className="sh-section-gap">
          ...
          {loading ? (
            ...
            <div className="sh-stats-grid">
              ...
              <StatCard
                label="Success Rate"
                value={stats?.successRatePercent?.toFixed(1) ?? "0.0"}
                icon={<MdTrendingUp />}
                color="blue"
                suffix="%"
              />
              <StatCard
                ...
                value={stats?.averageDeliveryMinutes?.toFixed(0) ?? "0"}
                icon={<MdTimer />}
                color="cyan"
                suffix=" min"
              />
              <StatCard
                label="Late Deliveries (30d)"
                value={stats?.lateDeliveries ?? 0}
                icon={<MdWarning />}
                color="amber"
              />
              <StatCard
          ...
          <div className="sh-card">
            <div className="sh-card-header">
              ...
              <Link href="/shipper/orders" className="sh-btn sh-btn-secondary sh-btn-sm">
                All Orders →
              </Link>
            </div>
            {activeOrder ? (
              ...
              >
                {[
                  { label: "Order #", value: activeOrder.orderNumber },
                  {
                    label: "Status",
                    value: (
                      <span className="sh-badge sh-badge-blue">
          ...
          <div className="sh-card">
            ...
            <div className="sh-quick-actions">
              <Link href="/shipper/tracking" className="sh-quick-action-btn">
                <span className="sh-quick-action-icon">
                  <MdLocationOn />
                </span>
                Update Location
              </Link>
...
// react-icons/md inline ref so it doesn't break tree-shaking
