package com.example.shop.modules.supplier.review.controller;
...
@RestController
@RequestMapping("/api/v1/supplier/reviews")
...
public class SupplierReviewController {
    ...
    /**
     * GET /api/v1/supplier/reviews/{productId}?limit=20
     *
     * Lists reviews for a product that belongs to the authenticated supplier.
     *
    ...
    /**
     * POST /api/v1/supplier/reviews/{productId}/{reviewId}/reply
     *
     * Allows the supplier to reply to a review on one of their own products.
     *
     * Request body:
    ...
    private void assertOwnsProduct(User user, String productId) {
        ...
        if (!user.getId().equals(product.getSupplierUserId())) {
