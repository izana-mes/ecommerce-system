...
public class TokenController {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<Void>> revokeToken(@PathVariable("tokenId") UUID tokenId) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<Void>> revokeAllUserTokens(@PathVariable("userId") UUID userId) {
