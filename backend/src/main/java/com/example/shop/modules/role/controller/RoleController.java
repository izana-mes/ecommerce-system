package com.example.shop.modules.role.controller;

import com.example.shop.common.response.ApiResponse;
import com.example.shop.modules.role.dto.request.AssignRoleRequest;
import com.example.shop.modules.role.dto.request.CreateRoleRequest;
import com.example.shop.modules.role.dto.response.RoleResponse;
import com.example.shop.modules.role.service.RoleService;
...
public class RoleController {
    ...
    public ResponseEntity<ApiResponse<List<RoleResponse>>> getUserRoles(@PathVariable("userId") UUID userId) {
